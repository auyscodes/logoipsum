      ...
      <div className="flex h-screen">
        <div className="m-auto">
          <div
            ...
            className="w-[800px] h-[430px] flex items-center justify-center m-auto bg-white rounded-lg overflow-hidden"
          >
            <div className="flex flex-wrap h-full">
              <div className="w-full lg:w-3/5 px-12 lg:px-10 py-10">
                ...
                <p className="mb-6 text-lg text-gray-500 h-36 overflow-hidden">
                  ...
                  perhaps best known for his roles as Hal, the father in the Fox
                  situation comedy "Malcolm in the Middle", and as Walter White
                  in the AMC drama series Breaking Bad, for which he has won
                  three consecutive Outstanding Lead Actor in a Drama Series
                  Emmy Awards. Other notable roles include Dr. Tim Whatley on
                  Seinfeld, Doug Heffernan's neighbor in The King of Queens,
                  Astronaut Buzz Aldrin in From the Earth to the Moon, and Ted
                  Mosby's boss on How I Met Your Mother.
                </p>
                <div className="flex items-center">
                  <a
                    target="_blank"
                    href="https://www.facebook.com/BryanCranston"
                  ...
                  <a
                    target="_blank"
                    href="https://www.twitter.com/BryanCranston"
                    className="inline-flex items-center justify-center w-12 h-12 mr-4 bg-blue-50 text-blue-500"
                  >
                    <svg
                      width="19"
                  ...
                  <a
                    target="_blank"
                    href="https://www.instagram.com/BryanCranston"
                    className="inline-flex items-center justify-center w-12 h-12 mr-4 bg-blue-50 text-blue-500"
                  >
                    <svg
                      width="24"
                  ...
                  <a
                    target="_blank"
                    href="https://www.imdb.com/name/nm0186505"
                    className="inline-flex items-center justify-center w-12 h-12 mr-4 bg-blue-50 text-blue-500"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
