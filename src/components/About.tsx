        ...
        <div className="relative">
          ...
          <div className="flex flex-row">
            ...
            <div className="flex-1">
                ...
                Key indicators that we look for: No space between the baby teeth
                at 4 years old, uneven upper or lower front teeth, set back upper
                or lower jaw, facial lengthening, teeth meeting the wrong way
                around (underbite), slack open mouth resting posture.
                </p>
            </div>
          ...
          <div className="flex flex-row">
            <div className="flex-1">
            <p className="text-lg text-blue-600 px-4">
                Patient compliance is also a key part of our treatment programme,
              we achieve this with education and patience throughout the
              process.
            </p>
            </div>
          ...
          <div className="flex flex-row">
            <div className="flex-1">
            <p className="text-lg text-blue-600 px-4">
            You will leave your initial appointment with a good understanding
            of the treatment and support from our specialised team.
            </p>
            </div>
