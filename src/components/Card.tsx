        ...
        <div className="pt-6 pb-6 bg-white">
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center w-12 h-12 mx-2 bg-blue-50"
            >
              <svg
                width="10"
                height="18"
            ...
            <a
              target="_blank"
              href="https://www.twitter.com/aaronpaul_8"
              className="inline-flex items-center justify-center w-12 h-12 mx-2 bg-blue-50"
            >
              <svg
                width="19"
            ...
            <a
              target="_blank"
              href="https://www.instagram.com/glassofwhiskey"
              className="inline-flex items-center justify-center w-12 h-12 mx-2 bg-blue-50"
            >
              <svg
                width="24"
            ...
            <a
              target="_blank"
              href="https://www.imdb.com/name/nm0666739"
              className="inline-flex items-center justify-center w-12 h-12 mx-2 bg-blue-50"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
